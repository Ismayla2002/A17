...
// Auth information
global.pairNumber = "221705059739";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["221763235153", "221705059739"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["221763235153", "221705059739"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["221705059739"];
global.OwnerName = process.env.OWNER_NAME || "Ismail";
global.BotName = process.env.BOT_NAME || "Maïna-Bot";
global.packname = process.env.PACK_NAME || "A17 Bot";
global.author = "By: Ismail";
